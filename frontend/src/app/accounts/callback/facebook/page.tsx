...
export default function FacebookCallbackPage() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/oauth/facebook/callback", {
      method: "POST",
      headers: {
      ...
      .catch((err) => {
        setError(err.message || "An unexpected error occurred during page association.");
      });
  }, [router]);
      ...
      <div className="w-full max-w-md glass-panel p-8 text-center">
        {error ? (
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold text-white mb-2">Connecting Facebook Page</h2>
            <p className="text-sm text-purple-300/70">
              Please wait while we associate your Facebook Page access tokens...
            </p>
          </div>
        )}
      </div>
